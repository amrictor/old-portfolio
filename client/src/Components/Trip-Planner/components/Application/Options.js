...
import {ButtonGroup, Button, CardBody, CardTitle, Container, Form} from 'reactstrap'
    ...
    render() {
        ...
        return (
                <Container id={"Options"}>
                    <CardBody>
                        <CardTitle><i>This page allows the user to choose units, type of map to view, and the preferred algorithm for optimization (from Nearest Neighbor, 2-Opt, and 3-Opt, respectively). Because many teams of students worked on versions of the same project, interoperability was an important feature and the bottom setting allows a user to connect this client to a different team's server.</i></CardTitle>
                        <hr/>
