    ...
    render() {
        ...
        return (
            <IconContext.Provider value={{ size: '1.8em' }}>
                <Container>
                    <CardBody id="Plan">
                        <CardTitle><i>This is a demo for a trip planning service created by team 23 in CS314 at Colorado State University. What you see is only the client-side of the program, and therefore not fully functional. The full program can search a database of locations and add them to the map and itinerary while calculating and optimizing the distance of the whole trip.<br/><br/>An example trip has been loaded already and can be seen in the itinerary and on the map below.</i></CardTitle>
                        <hr/>
                        <Row>
                            <Col lg="5">
                                {functions}
