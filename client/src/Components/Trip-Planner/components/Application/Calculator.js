...
import { Button, CardBody, CardTitle, Container, Form, FormGroup, Label } from 'reactstrap'
...
class Calculator extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <CardBody>
                    <CardTitle><i>This page makes a request to the server to calculate the distance between two latitude/longitude pairs.</i></CardTitle>
                    <hr/>
                    {fromto_field}
